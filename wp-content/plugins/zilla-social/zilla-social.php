...
class ZillaSocial {
	...
	function admin_menu() 
	{
		...
		$page_hook = add_menu_page( __( 'ZillaSocial Settings', 'zilla' ), __( 'ZillaSocial', 'zilla' ), 'update_core', 'zilla-social', array(&$this, 'settings_page'), $icon_url );
		add_submenu_page( 'zilla-social', __( 'Settings', 'zilla' ), __( 'ZillaSocial Settings', 'zilla' ), 'update_core', 'zilla-social', array(&$this, 'settings_page') );
		// ZillaFramework link
		add_submenu_page( 'zillaframework', __( 'ZillaSocial', 'zilla' ), __( 'ZillaSocial', 'zilla' ), 'update_core', 'zilla-social', array(&$this, 'settings_page') );
	}
